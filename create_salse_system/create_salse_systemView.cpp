...
// create_salse_systemView.cpp : Ccreate_salse_systemView 类的实现
//
...
// Ccreate_salse_systemView 构造/析构
...
Ccreate_salse_systemDoc* Ccreate_salse_systemView::GetDocument() const // 非调试版本是内联的
{
...
// Ccreate_salse_systemView 消息处理程序
